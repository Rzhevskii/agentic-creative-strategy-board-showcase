...
1. `screenshots/01-ui-structured-brief-intake.png` — structured brief intake UI.
2. `screenshots/02-ui-filled-brief-example.png` — filled demo brief example.
3. `screenshots/03-ui-result-creative-story-board.png` — generated creative strategy board.
